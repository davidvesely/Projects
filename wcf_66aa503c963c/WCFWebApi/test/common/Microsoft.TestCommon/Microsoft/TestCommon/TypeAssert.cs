...
namespace Microsoft.TestCommon
{
    ...
    {
        private static TypeAssert singleton = new TypeAssert();

        public static TypeAssert Singleton { get { return singleton; } }
        ...
        {
            Assert.IsNotNull(type, "Unit test error: type cannot be null.");
            Assert.IsTrue(expected == actual, string.Format("Type '{0}' should{1} be {2}.", type.FullName, expected ? "" : " NOT", property));
        }
        ...
        {
            this.HasProperties(typeof(T), typeProperties);
        }
        ...
        {
            this.HasProperties(typeof(T), typeProperties, typeof(TIsAssignableFrom));
        }
        ...
        {
            this.HasProperties(type, typeProperties, null);
        }
