...
namespace SecureServices.Infrastructure
{
    ...
    {
        private static readonly Uri FacebookAccessTokenBaseUri = new Uri(
            "https://graph.facebook.com/oauth/access_token");

        private static readonly Uri FacebookBaseGraphUri = new Uri("https://graph.facebook.com/me");
                        ...
                        () =>
                            {
                                ...
                                responseContentBuilder.AppendLine(
                                    "         if(window.opener && window.opener.OAuthDlgClosed){");
                                responseContentBuilder.AppendLine("            window.opener.OAuthDlgClosed();");
        ...
        {
            var builder = new UriBuilder(FacebookBaseGraphUri) { Query = string.Format("access_token={0}", accessToken) };
