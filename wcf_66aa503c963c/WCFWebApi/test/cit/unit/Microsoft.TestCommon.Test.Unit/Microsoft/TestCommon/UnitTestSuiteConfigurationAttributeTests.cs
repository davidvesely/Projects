...
namespace Microsoft.TestCommon.CIT.Unit
{
    ...
    [TestClass]
    public class UnitTestSuiteConfigurationAttributeTests : UnitTest<UnitTestSuiteConfigurationAttribute>
    {
        #region Type

        [TestMethod]
        [TestCategory("CIT"), Owner("roncain"), Timeout(TimeoutConstant.DefaultTimeout)]
        [Description("UnitTestSuiteConfigurationAttribute type is a public, concrete and sealed class")]
