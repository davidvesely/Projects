...
#pragma warning restore 618
    internal class CodeGenerator
    {
        ...
        internal void Store(object var)
        {
            ...
            {
                throw Fx.Exception.AsError(new InvalidOperationException(SR2.SFxCodeGenCanOnlyStoreIntoArgOrLocGot0(var.GetType().FullName)));
            }
        }
        ...
        internal void Ldc(object o)
        {
            ...
            else
            {
                switch (Type.GetTypeCode(valueType))
                {
                    ...
                    default:
                        throw Fx.Exception.AsError(new InvalidOperationException(SR2.SFxCodeGenUnknownConstantType(valueType.FullName)));
                }
            }
        }
        ...
        internal void Ldelem(Type arrayElementType)
        {
            ...
            else
            {
                ...
                if (opCode.Equals(OpCodes.Nop))
                {
                    throw Fx.Exception.AsError(new InvalidOperationException(SR2.SFxCodeGenArrayTypeIsNotSupported(arrayElementType.FullName)));
                }
            ...
            else
            {
                ...
                if (opCode.Equals(OpCodes.Nop))
                {
                    throw Fx.Exception.AsError(
                        new InvalidOperationException(SR2.SFxCodeGenArrayTypeIsNotSupported(arrayElementType.FullName)));
                }
        ...
        void InternalConvert(Type source, Type target, bool isAddress)
        {
            ...
            if (target.IsValueType)
            {
                if (source.IsValueType)
                {
                    ...
                    if (opCode.Equals(OpCodes.Nop))
                    {
                        throw Fx.Exception.AsError(new InvalidOperationException(SR2.SFxCodeGenNoConversionPossibleTo(target.FullName)));
                    }
                    else
                    {
                        if (codeGenTrace != CodeGenTrace.None)
                ...
                {
                    throw Fx.Exception.AsError(new InvalidOperationException(SR2.SFxCodeGenIsNotAssignableFrom(target.FullName, source.FullName)));
                }
            }
        ...
        {
            throw Fx.Exception.AsError(new InvalidOperationException(SR2.SFxCodeGenExpectingEnd(expected.ToString())));
        }
