...
namespace System.Net.Http
{
    ...
    public class MultipartFormDataStreamProvider : IMultipartStreamProvider
    {
        ...
        private Dictionary<string, string> bodyPartFileNames = new Dictionary<string, string>();
            ...
            get
            {
                lock (this.thisLock)
                {
                    return this.bodyPartFileNames != null ?
                        new Dictionary<string, string>(this.bodyPartFileNames) : new Dictionary<string, string>();
                }
            }
        }
        ...
        protected virtual Stream OnGetStream(HttpContentHeaders headers)
        {
            ...
            if (contentDisposition != null)
            {
                ...
                if (!string.IsNullOrEmpty(contentDisposition.FileName))
                {
                    ...
                    lock (this.thisLock)
                    {
                        this.bodyPartFileNames.Add(contentDisposition.FileName, localFilePath);
                    }
            ...
            throw new IOException(SR.MultipartFormDataStreamProviderNoContentDisposition("Content-Disposition"));
        }
