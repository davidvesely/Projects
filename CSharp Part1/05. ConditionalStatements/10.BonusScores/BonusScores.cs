...
class BonusScores
{
    static void Main()
    {
        ...
        Console.WriteLine();
        char keyPressed = consoleKey.KeyChar;
        int result = 0;
        bool isValid = true;
        switch (keyPressed)
        {
            ...
            case '2':
            case '3':
                result = int.Parse(keyPressed.ToString()) * 10;
                break;
            case '4':
            case '5':
            case '6':
                result = int.Parse(keyPressed.ToString()) * 100;
                break;
            case '7':
            case '8':
            case '9':
                result = int.Parse(keyPressed.ToString()) * 1000;
                break;
            default:
                isValid = false;
                break;
